...
Aoi.orders.render = function () {
  ...
  tbody.innerHTML = rows.map(function (o, i) {
    ...
    return '<tr class="border-b border-gray-100 hover:bg-gray-50 align-top">'
      ...
      + '<td data-label="活动" class="px-3 py-2 wrap">' + Aoi.escapeHtml(o.activity || '—') + '</td>'
      + '<td data-label="制品类型" class="px-3 py-2 wrap">' + Aoi.escapeHtml(o.type) + '</td>'
      + '<td data-label="型号" class="px-3 py-2 wrap">' + Aoi.escapeHtml(o.model) + '</td>'
      + '<td data-label="单价(¥)" class="px-3 py-2 text-right wrap">' + Aoi.orders.priceText(o) + '</td>'
      + '<td data-label="外币原价" class="px-3 py-2 text-right whitespace-nowrap">' + Aoi.orders.origText(o) + '</td>'
      + '<td data-label="数量" class="px-3 py-2 text-right">' + o.count + '</td>'
      + '<td data-label="购买者" class="px-3 py-2 wrap">' + Aoi.escapeHtml(o.buyer) + '</td>'
